-- lägger in tre olika utbildningsprogram
INSERT INTO program (program_namn) VALUES
('Data Engineering'),
('Webbutveckling'),
('Nätverkstekniker');
-- lägger in fyra utbildningsledare och deras personuppgifter
...
-- lägger in utbildare och deras personuppgifter
...
-- lägger in företag för konsulter
...
-- kopplar utbildare som konsulter till företag
...
-- kopplar utbildare till sina kurser
